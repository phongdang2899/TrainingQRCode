...
CREATE TABLE `transactions`  (
  ...
  CONSTRAINT `transactions_customer_id_foreign` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT,
...
CREATE TABLE `transaction_items`  (
  ...
  `transaction_info` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL,
...
CREATE TABLE `configs`  (
  ...
  INDEX `configs_entity_id_entity_type_index`(`entity_id`, `entity_type`) USING BTREE,
  INDEX `configs_value_index`(`value`(768)) USING BTREE,
...
-- Records of configs
-- ----------------------------
INSERT INTO `configs` VALUES (1, 'failed_ip', 'limit', '5', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (2, 'failed_ip', 'unblock_after', '180', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (3, 'failed_ip', 'expired_after', '10', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (4, 'otp', 'limit', '3', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (5, 'otp', 'expired_after', '60', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (6, 'otp', 'unblock_after', '24', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (7, 'sms_api', 'cp_id', '1234', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (8, 'sms_api', 'cp_name', 'abc', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (9, 'sms_api', 'user', 'abc', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (10, 'sms_api', 'pass', 'abc', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (11, 'sms_api', 'brand_name', 'Vinh Tuong', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (12, 'sms_api', 'msg_body', 'Ma OTP cua ban la: {OTP}. Ma co hieu luc trong {expired_time} phut. Vui long khong chia se ma OTP voi bat ky ai. Xin cam on!', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (13, 'reCapcha_v2', 'public_key', '6LeIJp8bAAAAAGeU4fE25ACgheSjLXIBdriDf8he', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (14, 'reCapcha_v2', 'private_key', '6LeIJp8bAAAAAMna04BesyI1XV6FAxRY1VgFibi0', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
INSERT INTO `configs` VALUES (15, 'code', 'site_key', 'b3b5cb0a-9419-5772-ad37-55519bd76f10', 1, 1, 1, '2021-07-20 13:36:39', '2021-07-20 13:36:39');
...
-- ----------------------------
INSERT INTO `campaigns` VALUES (1, 'Gạch Men', 'gach-men', '2021-07-15 17:03:04', '2021-07-20 17:03:08', 1, 1, NULL, NULL, '2021-07-15 17:03:45', NULL, NULL);
INSERT INTO `campaigns` VALUES (2, 'Vật liệu Chống nhiệt', 'chong-nhiet', '2021-07-28 16:44:56', '2021-08-07 16:45:03', 1, 1, NULL, NULL, '2021-07-17 16:45:24', NULL, NULL);
INSERT INTO `campaigns` VALUES (3, 'Đá lát', 'dat-lat', '2021-07-14 16:45:45', '2021-07-29 16:46:09', 0, 1, NULL, NULL, '2021-07-17 16:46:18', NULL, NULL);
...
INSERT INTO `campaign_configs` VALUES (3, 2, '50000', 15000, 0, 1, NULL, '2021-07-17 17:44:51', NULL);
